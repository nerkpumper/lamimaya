...
<!-- <pre>{{ $data.productoAEnlistar }}</pre> -->
	...
	<div v-if="pedidoSoloParaObra" class="alert alert-info" >Pedido/Cotizaci&oacute;n en OBRA. Recuerde los productos para este tipo de pedido son L&aacute;minas que se procesar&aacute;n all&aacute;, si tiene mas materiales debe manejarlos en otro pedido como ENTREGA o RECOGE.</div>
	<div class="row" >
		<div class="col-md-12">
			<div class="ibox" >
				<div class="ibox-title">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
							...
							<datalist id="lstProductos">
								<option v-for="item in productosParaFiltro"
									v-if="!pedidoSoloParaObra || (pedidoSoloParaObra && item.soloObra == 'SI') "
                                	...
                                	<div class="row">
    									...
    									<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
    										<select v-model="selRecogeRecibe" class="form-control">
    											<option v-show="!pedidoSoloParaObra" value="NOSEL">-- Seleccione --</option>
    											<option v-show="!pedidoSoloParaObra" value="RECOGE">RECOGE EL CLIENTE</option>
    											<option v-show="!pedidoSoloParaObra" value="ENTREGA">SE ENVIA AL CLIENTE</option>
    											<option v-show="pedidoSoloParaObra" value="OBRA">SE FABRICA EN OBRA</option>
    										</select>
    									</div>
...
// //     echo "<pre>{{ \$data }}</pre>";
 ...
 echo "<pre>{{ \$data.productos }}</pre>";
 echo "<pre>{{ \$data.productosParaFiltro }}</pre>";
