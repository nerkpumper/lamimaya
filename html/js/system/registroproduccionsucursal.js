...
var app = new Vue({
	...
	data: {
		...
		//shows
		showGuardarlargoRollo: false,
		showGuardarEspesor: true,
		showBotonConcluirResgistroProduccion: false,
...
//			console.log(val);
	...
	methods: {
		...
		seleccionarNoRemision: function(indexrollo, indexnorollo){
			...
			this.idSucursalSeleccionado= this.rollos[indexrollo].noRollos[indexnorollo].idSucursal;
...
//				  "rollo: " + this.rollos[indexrollo].descripcion );
		...
		cargarDatosRegistroProduccionAbierto: function(){
			if (this.espesor > 0)
			{
				this.showGuardarEspesor = false;
				this.showBotonConcluirResgistroProduccion=true;
...
//			alert("vamos a cargar registro produccion: " + this.idRegistroProduccion);
		...
		registrarRPStock: function(){
			...
			{
//				console.log((this.rpKilosMaquilados + this.stockTotalKG));
//				console.log((this.rpKilosRollo * 1.1));
				if (parseFloat((parseFloat(this.rpKilosMaquilados) + parseFloat(this.stockTotalKG))) < parseFloat((parseFloat(this.rpKilosRollo) * 1.1)))
				{
					swal({
				        title: "Confirme",
				    	...
				    	xajax_registrarRPStock(app.idRolloSeleccionado, app.idRemisionRolloSeleccionado, app.idRegistroProduccion, app.stockIdProducto, app.stockPiezas, app.stockML, app.pesoEstimadoXKiloRolloSeleccionado, app.stockTotalKG, app.idSucursalSeleccionado);
...
//				console.log((this.rpKilosRollo * 1.1));
				if (parseFloat((parseFloat(this.rpKilosMaquilados) + parseFloat(this.pycTotalKG))) < parseFloat((parseFloat(this.rpKilosRollo) * 1.1)))
				{
					swal({
				        title: "Confirme",
				        text: "Se ingresará la información indicada y se harán movimientos en inventario sobre el Número de Rollo y el Rollo en General",
				    	...
				    	xajax_registrarRPPyc(app.idRolloSeleccionado, app.idRemisionRolloSeleccionado, app.idRegistroProduccion, app.pycPiezas, app.pycML, app.pesoEstimadoXKiloRolloSeleccionado, app.pycTotalKG, app.idSucursalSeleccionado);
//				    	xajax_registrarRPStock(this.idRegistroProduccion, this.stockPiezas, this.stockML, this.pesoEstimadoXKiloRolloSeleccionado, this.stockTotalKG);
				    });	
				}
				else
		...
		cargarPedidoDetalle: function(){
			...
			xajax_cargarDatosPedido(this.pedidoIdPedido, this.idRolloSeleccionado, this.idSucursalSeleccionado);
		},
...
//				console.log((this.rpKilosRollo * 1.1));
				if (parseFloat((parseFloat(this.rpKilosMaquilados) + parseFloat(this.pedidoKGDespachar))) < parseFloat((parseFloat(this.rpKilosRollo) * 1.1)))
				{
					if(parseFloat(this.pedidoPiezas) <= parseFloat(this.pedidoPorDespachar))				
					{
						swal({
					        title: "Confirme",
					        text: "Se ingresará la información indicada y se harán movimientos en inventario sobre el Número de Rollo y el Rollo en General",
					    	...
					    	xajax_registrarRPPedido(app.idRolloSeleccionado, app.idRemisionRolloSeleccionado, app.idRegistroProduccion, app.pedidoIdPedidoDetalle, app.pedidoPiezas, app.pedidoML, app.pesoEstimadoXKiloRolloSeleccionado, app.pedidoKGDespachar, app.pedidoIdPedidoDetalleColocacion, app.idSucursalSeleccionado);
//					    	xajax_registrarRPStock(this.idRegistroProduccion, this.stockPiezas, this.stockML, this.pesoEstimadoXKiloRolloSeleccionado, this.stockTotalKG);
					    });		
					}
					else
		...
		guardarEspesor: function(){
			
		    	
		    	xajax_guardarEspesor(this.espesor, this.idRegistroProduccion);
//		    	xajax_registrarRPStock(this.idRegistroProduccion, this.stockPiezas, this.stockML, this.pesoEstimadoXKiloRolloSeleccionado, this.stockTotalKG);
		    	
			
		},
		guardarLargoRollo: function(){
			
		    	
			xajax_guardarLargoRollo(this.largoRollo, this.idRegistroProduccion);
//		    	xajax_registrarRPStock(this.idRegistroProduccion, this.stockPiezas, this.stockML, this.pesoEstimadoXKiloRolloSeleccionado, this.stockTotalKG);
