<?php
$titlePage = "Precios";
$breadCum = "Precios/Ternium";
//$buttonAction = "";
$_lugar = LUGAR_PRECIOS_TERNIUM;
...
// 		$precios .= "  <td>CAL 24 -- {{ precios[".$i."].calibre24[0].id }}</td>";
		...
		$precios .= "<tr>";
// 		$precios .= "  <td>CAL 22 -- {{ precios[".$i."].calibre22[0].id }}</td>";
		$precios .= "  <td>CAL 22</td>";
		for ($j=1 ; $j <= 10 ; $j++)
		{
			$precios .= "  <td>";
			$precios .= "    <input type='text' class='form-control text-right' v-model='precios[".$i."].calibre22[0].precio".$j."' oninput=\"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');\" maxlength='8'>";
			$precios .= "  </td>";
		}
		$precios .= "</tr>";
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<h5>Lista de Precios por Dobleces Ternium</h5>				
			</div>
