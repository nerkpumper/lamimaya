									...
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            							<div class="form-group">
                							...
                							<input
            									...
            									maxlength="9" class="form-control" autofocus="autofocus">
								...
								<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 m-b">
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            							<div class="form-group">
            								...
            								<div v-show="molCantUnidad > 6.1 || molCantUnidad <= 0" class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                    							<div class="alert alert-danger">
                    								Este valor debe ser mayor a cero y menor a 6.1
                    							</div>
                    						</div>
            							</div>
            						</div>
			...
			<div class="ibox">
				...
				<div class="ibox-content">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"
							style="padding-top: 10px">
							<a href="<?php echo URL_BASE?>pedidonuevo5"
	...
	<!-- 							</tfoot> -->
                        ...
                        <div class="row" v-if="idClienteSeleccionado != 137">
							<div  v-show="maxTipoPrecioGalvamexAcryOpa > 1" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										<h3>Rango Precios Acrylit, Opalit, Tizacril, Galvateja, Poliester </h3>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
<!-- 											<tr v-show="listadoPedido.length > 0 || totalOtrosCargos > 0"> -->
											...
											<tr v-show="descuentoPedido > 0">												
												<td><img src="<?php echo URL_BASE;?>\img\buenfin.png" style="width: 64px;"><strong>DESCUENTO {{ porDescuento }} %:</strong></td>
