...
$_lugar = LUGAR_PROMOTOR_PEDIDOSCLIENTES;
							...
							<table  v-show="!loading" id="tablaToExcel" class="table table-hover margin bottom">
								<thead>
									<tr>
										...
										<th class="text-right">Cargos Promotor</th>
										<th class="text-right">Abonos Promotor</th>
										<th class="text-right">Saldo Promotor</th>
								...
								<tbody>
									<tr v-for="(ped, index) in pedidos">
										...
										<td class="text-right text-primary">$ {{ formatNumber(ped.cargospromotor) }}</td>
										<td class="text-right text-success">$ {{ formatNumber(ped.abonospromotor) }}</td>
										<td class="text-right text-danger">$ {{ formatNumber(ped.saldopromotor) }}</td>
