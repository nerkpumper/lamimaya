...
//			if (hasta < desde)
		...
		sendToExcel: function(){
			...
			if (sel != "0")
			{
				sendToExcel("tblReporte", "Listado de Pedidos Galvamex", "Listado de Pedidos Galvamex", "Promotor: " + $("#selPromotor :selected").text() + " de: " + this.filtro.fechaInicio + " a: " + this.filtro.fechaFin);	
			}
			else
			{
				sendToExcel("tblReporte", "Listado de Pedidos Galvamex", "Listado de Pedidos Galvamex", "Todos los Promotores de: " + this.filtro.fechaInicio + " a: " + this.filtro.fechaFin);
			}
