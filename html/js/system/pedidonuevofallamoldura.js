	...
	computed: {
	    ...
	    rollosExistenciasXDesarrollo34:function(){
	    	 ...
	    	 return this.rollosExistencias.filter(function(cust){
	    		 ...
	    		 return cust.pies >= 3 && cust.pies <= 4;
...
//				console.log("Total ml Galvateja: " + this.totalMLGalvateja);
			...
			if (this.calcularRangosPrecios)
			{
				...
				*/
				...
				if (this.tipoPrecioGalvamexMultipanel > this.maxTipoPrecioGalvamexMultipanel)
				{
				...
				*/
				...
				if (this.tipoPrecioGalvamexGalvateja > this.maxTipoPrecioGalvamexGalvateja)
				{
				...
				*/
				...
				if (this.tipoPrecioGalvamexRolloKilo > this.maxTipoPrecioGalvamexRolloKilo)
				{
