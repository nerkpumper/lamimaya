	...
	function register($aArgs)
	{
		if (1 < count($aArgs))
		{
			...
			if (XAJAX_FUNCTION == $sType)
			{
				...
				{
					$nrkxajaxuserfunction136 = new xajaxUserFunction($xuf);
					$xuf =& $nrkxajaxuserfunction136;
				}
...
$nrkxajaxuserfunction233 = xajaxPluginManager::getInstance();
$objPluginManager =& $nrkxajaxuserfunction233;

$nrkxajaxuserfunction236 = new xajaxFunctionPlugin();
$objPluginManager->registerPlugin($nrkxajaxuserfunction236, 100);
