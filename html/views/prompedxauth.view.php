<?php
$titlePage = "Pedidos X Autorizar";
$breadCum = "Promotor/Pedidos x Autorizar";
$_lugar = LUGAR_PROMOTOR_AUTORIZAPEDIDOS;
//$_useDataTable = true;
						...
						<table class="table table-bordered table-striped table-hover">
							...
							<tbody>
								...
								<tr v-for="ped in pedidos">
									...
									<td>$ {{ ped.total }}</td>
									<td>{{ ped.fecha }}</td>
									<td><button @click.prevent="seleccionaPedido(ped.idPedido)" class="btn btn-primary btn-xs">Procesa Autorizaci&oacute;n</button></td>
								</tr>
