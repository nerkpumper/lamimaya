<?php
	...
	class ModeloBaseCxccortecomision extends clsBasicCommon
	{
		#------------------------------------------------------------------------------------------------------#
		#----------------------------------------------Propiedades---------------------------------------------#
		#------------------------------------------------------------------------------------------------------#
		var $_nombreClase="base.ModeloBaseCxccortecomision";

		
		var $idCxcCorteComision=0;
		...
		var $__s=array("idCxcCorteComision",
                       "idCorteComision",
                       "idPromotor",
                       "movimiento",
                       "monto",
		...
		public function setIdCxcCorteComision($idCxcCorteComision)
		{
			if($idCxcCorteComision==0||$idCxcCorteComision==""||!is_numeric($idCxcCorteComision)|| (is_string($idCxcCorteComision)&&!ctype_digit($idCxcCorteComision)))return $this->setError("Tipo de dato incorrecto para idCxcCorteComision.");
			$this->idCxcCorteComision=$idCxcCorteComision;
			$this->getDatos();
		}
		...
		public function getIdCxcCorteComision()
		{
			return $this->idCxcCorteComision;
		}
		...
		protected function Insertar()
		{
			try
			{
				$SQL="INSERT INTO " . $this->__tableName . " (idCorteComision,
				                                              idPromotor,
				                                              movimiento,
				                                              monto,
				                                              saldoActual,
				                                              ...
				                                              fecha_movimiento,
				                                              id_usuario_movimiento)
						VALUES('" . mysqli_real_escape_string($this->dbLink,$this->idCorteComision) . "',
				...
				if(!$result)
					return $this->setSystemError("Error en la insercion de registro.","[" . $SQL . "][" . mysqli_error($this->dbLink) . "][ModeloBaseCxccortecomision::Insertar]");
				
				$this->idCxcCorteComision=mysqli_insert_id($this->dbLink);
				return true;
			}
			catch (Exception $e)
			{
		...
		protected function Actualizar()
		{
			try
			{
				$SQL="UPDATE " . $this->__tableName . " SET idCorteComision='" . mysqli_real_escape_string($this->dbLink,$this->idCorteComision) . "',
					...
					WHERE idCxcCorteComision=" . $this->idCxcCorteComision;
				
				$result=mysqli_query($this->dbLink,$SQL);
				if(!$result)
					return $this->setSystemError("Error en la actualizacion de registro.","[" . $SQL . "][" . mysqli_error($this->dbLink) . "][ModeloBaseCxccortecomision::Update]");
		...
		public function Borrar()
		{
			...
			try
			{
				...
				WHERE idCxcCorteComision=" . mysqli_real_escape_string($this->dbLink,$this->idCxcCorteComision);
				$result=mysqli_query($this->dbLink,$SQL);
				if(!$result)
					return $this->setSystemError("Error en el borrado de registro.","[" . $SQL . "][" . mysqli_error($this->dbLink) . "][ModeloBaseCxccortecomision::Borrar]");
			}
			catch (Exception $e)
			{
				return $this->setErrorCatch($e);
		...
		public function getDatos()
		{
			try
			{
				...
				$result=mysqli_query($this->dbLink,$SQL);
				if(!$result)
					return $this->setSystemError("Error en la obtencion de detalles de registro.","[ModeloBaseCxccortecomision::getDatos][" . $SQL . "][" . mysqli_error($this->dbLink) . "]");
