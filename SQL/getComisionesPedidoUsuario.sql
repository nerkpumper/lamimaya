DROP function IF EXISTS `getComisionesPedidoUsuario`;

DELIMITER $$
CREATE FUNCTION `getComisionesPedidoUsuario`(`pIdPedido` INTEGER, `pIdUsuario` INTEGER) RETURNS decimal(15,2)
BEGIN
