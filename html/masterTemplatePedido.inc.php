                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div class="sidebar-title">
							<div class="input-group m-b">
								...
								<input v-model="searchCotizacion" type="text" placeholder="ID o Cliente" class="form-control">
							</div>
                        </div>

                        <ul class="sidebar-list">
                            <li v-for="coti in listaCotizacionesFiltradas">
                                <a href="#">
                                    <div class="small pull-right m-t-xs">{{ coti.fecha_capturado }}</div>
                                    <h4>Folio: {{ coti.idCotizacion }}</h4>
                                    <h5>{{ coti.nombreCliente }}</h5>
									Total: {{ coti.total}}
									<br>
									Tipo: {{ coti.recogeentrega}}
									
                                    <div class="small">Vigencia: {{ coti.diasRestantes }} d&iacute;as</div>
                                    <div class="progress progress-mini progress-striped active">
                                        <div :style="'width: ' + coti.porcentajeVigencia + '%'" :class="'progress-bar progress-bar-' + coti.tipoProgress"></div>
                                    </div>
									...
									<div class="pull-right">
										...
										<button @click.prevent="DeleteCotizacion(coti.idCotizacion)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<button @click.prevent="LoadCotizacion(coti.idCotizacion)" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></button>									
									</div>
									

									
									<a :href="'<?php echo URL_BASE;?>cotizacionpdf?id=' + coti.idCotizacion"										
