<?php
	...
	class ModeloBaseCxccuentacomisionroofing extends clsBasicCommon
	{
		#------------------------------------------------------------------------------------------------------#
		#----------------------------------------------Propiedades---------------------------------------------#
		#------------------------------------------------------------------------------------------------------#
		var $_nombreClase="base.ModeloBaseCxccuentacomisionroofing";

		
		var $idCxcCuentaComisionRoofing=0;
		var $idUsuario=0;
		var $tipo='DEDUCIR';
		...
		var $__s=array("idCxcCuentaComisionRoofing",
                       "idUsuario",
                       "tipo",
                       "idConceptoGasto",
                       "fecha_creacion",
		...
		public function setIdCxcCuentaComisionRoofing($idCxcCuentaComisionRoofing)
		{
			if($idCxcCuentaComisionRoofing==0||$idCxcCuentaComisionRoofing==""||!is_numeric($idCxcCuentaComisionRoofing)|| (is_string($idCxcCuentaComisionRoofing)&&!ctype_digit($idCxcCuentaComisionRoofing)))return $this->setError("Tipo de dato incorrecto para idCxcCuentaComisionRoofing.");
			$this->idCxcCuentaComisionRoofing=$idCxcCuentaComisionRoofing;
			$this->getDatos();
		}
		...
		public function getIdCxcCuentaComisionRoofing()
		{
			return $this->idCxcCuentaComisionRoofing;
		}
		...
		protected function limpiarPropiedades()
		{
			...
			$this->idCxcCuentaComisionRoofing=0;
			$this->idUsuario=0;
			$this->tipo='DEDUCIR';
			...
			try
			{
				$SQL="INSERT INTO " . $this->__tableName . " (idUsuario,
						...
						VALUES('" . mysqli_real_escape_string($this->dbLink,$this->idUsuario) . "',
				               ...
				               '" . mysqli_real_escape_string($this->dbLink,$this->idCorteComisionRoofing) . "')";
				$result=mysqli_query($this->dbLink,$SQL);
				if(!$result)
					return $this->setSystemError("Error en la insercion de registro.","[" . $SQL . "][" . mysqli_error($this->dbLink) . "][ModeloBaseCxccuentacomisionroofing::Insertar]");
				
				$this->idCxcCuentaComisionRoofing=mysqli_insert_id($this->dbLink);
				return true;
			}
			catch (Exception $e)
			{
		...
		protected function Actualizar()
		{
			try
			{
				$SQL="UPDATE " . $this->__tableName . " SET idUsuario='" . mysqli_real_escape_string($this->dbLink,$this->idUsuario) . "',
	                                              ...
	                                              idCorteComisionRoofing='" . mysqli_real_escape_string($this->dbLink,$this->idCorteComisionRoofing) . "'
					WHERE idCxcCuentaComisionRoofing=" . $this->idCxcCuentaComisionRoofing;
				
				$result=mysqli_query($this->dbLink,$SQL);
				if(!$result)
					return $this->setSystemError("Error en la actualizacion de registro.","[" . $SQL . "][" . mysqli_error($this->dbLink) . "][ModeloBaseCxccuentacomisionroofing::Update]");
		...
		public function Borrar()
		{
			...
			try
			{
				...
				WHERE idCxcCuentaComisionRoofing=" . mysqli_real_escape_string($this->dbLink,$this->idCxcCuentaComisionRoofing);
				$result=mysqli_query($this->dbLink,$SQL);
				if(!$result)
					return $this->setSystemError("Error en el borrado de registro.","[" . $SQL . "][" . mysqli_error($this->dbLink) . "][ModeloBaseCxccuentacomisionroofing::Borrar]");
			}
			catch (Exception $e)
			{
				return $this->setErrorCatch($e);
		...
		public function getDatos()
		{
			try
			{
				...
				$result=mysqli_query($this->dbLink,$SQL);
				if(!$result)
					return $this->setSystemError("Error en la obtencion de detalles de registro.","[ModeloBaseCxccuentacomisionroofing::getDatos][" . $SQL . "][" . mysqli_error($this->dbLink) . "]");
		...
		public function Guardar()
		{
			...
			if($this->getError())
				return false;
			if($this->idCxcCuentaComisionRoofing==0)
				$this->Insertar();
			else
				$this->Actualizar();
			if($this->getError())
