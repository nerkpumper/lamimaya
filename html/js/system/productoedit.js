		...
		codigoGenerado: function(){
			...
			if (this.esAccesorio){
				...
				if (this.idProducto == 0){				
					this.codigo = this.claveTipoProducto + this.claveMaterial + this.textoAplicacion;
					
					if (this.calibre != '666' && this.calibre != '0')
					{
						this.codigo = this.codigo + "C" + this.calibre	
					}					
					
					if (this.pies > '0' && !this.esPieza)
					{
						this.codigo = this.codigo + this.pies + "FT";	
					}
					...
					if (this.idTipoProducto == 0 || this.idMaterial == 0 ||  (this.unidad != 4 && this.calibre == "0") || (this.idAplicacion == 0 && this.claveTipoProducto == "L"))				
					{
...
//			if (this.idTipoProducto == 0 || this.idMaterial == 0 || this.calibre == "0" || (this.idAplicacion == 0 && this.claveTipoProducto == "L"))
			...
			if (!this.esAccesorio && !this.esRollo)
			{
				...
				if (this.calibre == "666" && this.unidad != 4)
				{
					seguir = false;				
