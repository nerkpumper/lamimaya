				...
				<div class="ibox-content">
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"
							...
							<a
								:href="'<?php echo URL_BASE;?>tmppedidoprint?id=' + pedidoFolio"
	...
	<div class="modal-dialog">
		<div class="modal-content animated bounceInRight">
			<div class="modal-header">
				...
				<small class="font-bold">{{ codigoModal }}</small> <br> <small>Unidad
					<strong>{{ unidadModal }}</strong>
				</small>
				<!-- 						<br> -->
			...
			<div class="modal-body">
				...
				<div class="row m-b-xs">
					<div v-if="tipoPrecioModal != 'G'"
						class="col-lg-6  col-md-12 col-sm-12 col-xs-12 m-b">
						<div v-if="tipoPrecioModal == 'T'">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="form-group">
				...
				<div v-if="errorModal" class="row m-b-xs">
...
<div v-show="vistaPedido">
	...
	<div class="ibox-content ibox-heading">
		...
		<h3>
			...
			<i class="fa fa-user"></i> {{ clienteSeleccionado }}
			<button @click.prevent="seleccionarOtroCliente" class="btn btn-warning pull-right"><i class="fa fa-users"></i></button>
		</h3>
		<small><i class="fa fa-tim"></i> {{ promotorClienteSeleccionado }}</small>
				...
				<table id="tblProductosFiltrados"
					...
					<tbody>
						<tr v-for="(prod, index) in productosFiltradosPorTipo">
							<td>{{ prod.codigo }}</td>
							<td>{{ prod.fullDescripcion }}</td>
							<td>{{ prod.shortUnidad }}</td>
							<td><span v-if="prod.tipoPrecio == 'G'">GALVAMEX</span> <span
								v-else-if="prod.tipoPrecio == 'I'">IMPORTADOS</span> <span
									...
									<tr v-for="(item, index) in listadoPedido">
										...
										<td class="desc">
											...
											<div class="row m-b-xs">
												...
												<div v-if="item.tipoPrecio != 'G'"
													class="col-lg-3 col-md-12 col-sm-12 col-xs-12 m-b">
													<div v-if="item.tipoPrecio == 'T'">
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															<div class="form-group">
											...
											<dl class="small m-b-none">
												<dt>Tipo Precio</dt>
												<dd v-if="item.tipoPrecio == 'G'">GALVAMEX</dd>
												<dd v-else-if="item.tipoPrecio == 'I'">IMPORTADOS</dd>
												<dd v-else>TERNIUM</dd>
											</dl>
							...
							<table id="tblPedidoShort"
								...
								<tbody>
									<tr v-for="(item, index) in listadoPedido">
										...
										<td><span v-if="item.shortUnidad != 'PZA'"> {{ item.cantUnidad
