...
//							alert("vamos");
							...
							swal({
								title: "Confirme",
								text: "Se Ingresaran las remisiones y se afectaran las existencias del Material.",
								type: "warning",
							...
							//		    	app.showBotonCrearRegistroProduccion = false;
								// mdlShowWait();
								xajax_registrarIngresos(app.idRollo, app.almacen, app.comprador, app.remision, app.ingresos);	
							});	
