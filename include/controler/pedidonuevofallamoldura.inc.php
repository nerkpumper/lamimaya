...
// 	                          ,$strPersona, $strDireccion, $strNumero, $strColonia, $strCiudad, $fechaEntrega, $horaEntrega, $tipoPedido, $porDescuento, $maxDescuentoIndividual, $descuentoIndividual, $observacionPedido, $totalOtrosCargos, $otrosCargos
	...
	function levantarPedido($idClienteSeleccionado, $subtotalPedido, $ivaPedido, $descuentoPedido, $totalPedido, $tipoPrecioGalvamex ,$detalle, $recogeRecibe, $sucursalPreferencia, $strPersona, $strDireccion, $strNumero, $strColonia, $strCiudad, $fechaEntrega, $horaEntrega, $fechaAbierta, $pedidoExpress, $tipoPedido, $porDescuento, $maxDescuentoIndividual, $descuentoIndividual, $observacionPedido, $totalOtrosCargos, $otrosCargos, $molCostoDobles, $molCostoCorte, $buenfintipopago, $fechaEntregaPorDefinir, $tipoObra)
	{
		global $objSession;
		$r = new xajaxResponse();
...
//         $r->mostrarAviso("antes de recorrer renglones"); return $r;
		...
		foreach ($detalle as $item)
		{
			...
			if ($item["shortUnidad"] == "PZA" && $checarExistencia)
			{
				...
				{
					$strErrores .= ($strErrores == "" ? "" : "<br>") . utf8_encode("No se ha podido obtener la informaciï¿½n del Producto ".$item["fullDescripcion"].".");
					$blnDoCommit = false;
					break;
				}
