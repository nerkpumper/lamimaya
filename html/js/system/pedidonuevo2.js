...
function updateWithPromiseOut(index) {
	...
	//		Fin Alta Cliente
		...
		mounted: function () {
			...
			swal({
					title: "Atención",
					text: "¿El Pedido/Cotización que se manejará sera para OBRA?",
					type: "info",					
					...
					if (resp){
						app.pedidoSoloParaObra = true;						
						app.selRecogeRecibe = "OBRA";
						// app.cargarProductos(true);
					}
					else{						
						app.pedidoSoloParaObra = false;						
						// app.cargarProductos();
					}
...
//				console.log("Total OC: " + toc);
	...
	//			alert("Buscaremos " + this.productoAEnlistar);
			...
			cargarProductos: function(esObra){
				// console.log("cargar lista Productos");
				mdlShowWait("Cargando Productos");
				xajax_cargarListaProductos(esObra);
			},
	...
	// }, 400);
			...
			updateAllToCurrentPricesBack: function(){
				...
				setTimeout (function() { mdlExitWait(); app.calculaTotales(); console.log("Fin UpdateAllPrecios") }, 1500 + (550 * this.listadoPedido.length));
			},			
...
// 		app.productos.push({ idProducto: '576', 
// codigo: 'LPYC-KR-18 3.05 RPP242NTERG33', 
// isMoldura: false, longitud: '3.05', mlpieza: 3.05, idTipoProducto: '1', tipoProducto: 'LÁMINA', 
// shortTipoProducto: 'L', idAplicacion: '35', aplicacion: 'PYC-KR-18', idMaterial: '13', 
// material: 'PINTRO POLIESTER', curva: '', idRollo: '12', rolloCodigo: 'RPP242NTERG33', 
// rolloIdMaterial: '13', rolloMaterial: 'PINTRO POLIESTER', rolloShortMaterial: 'PP', rolloIdProveedor: '2', 
// rolloProveedor: 'TERNIUM', rolloShortProveedor: 'TER', rolloCalibre: '24', rolloPies: '2.00', 
// rolloPesokiloml: 2.71, rolloDescripcion: 'ROLLO PINTRO POLIESTER CAL 24 2 PIES NACIONAL TERNIUM', 
// idUnidad: '4', unidad: 'PIEZA', shortUnidad: 'PZA', calibre: '24', 
// descripcion: 'LAMINA PYC KR-18 DE 3.05 MTS PINTRO CALIBRE 24 DE 2 PIES TERNIUM GRADO 33', 
// existencia: '0.00', tipoPrecioComision: 'PRECIO', tipoPrecio: 'G', isRango: '0', 
// tipoRango: '', isRollo: '0', precio1: '268.74', precio2: '268.74', precio3: '268.74', preciomendez: '268.74', 
// estado: 'ACTIVO', existenciaEstimada: '0', 
// fullDescripcion: 'LÁMINA PUNTAS Y COLAS PYC-KR-18 PINTRO POLIESTER CAL 24 2.00 PIES NACIONAL TERNIUM GRADO 33 3.05 MTS',
//  cantidad: 1, lblUnidad: '', cantUnidad: 1, cantUnidadReal: 1, dobleces: '0', precioRenglon: '0', rangoRenglon: '1', totalRenglon: '0', desarrolloI: '0', 
//  desarrolloT: '0', dobleces: '0', debug: '', kl: 0, 
//  productoCantidadDisponible: true, molPrecioLamina: 0,
//  molMoldurasXLamina: 1, molMoldurasXLaminaTodos: 1, molLaminasCobrar: 1, molLaminasATomar: 1, molCorte: 0, 
//  molDobles: 0, molIsScrap: false, molTotalCMScrap: 0, molLongitudinal: 'L', sugerirStock: [], 
//  inventarioSucursal: [], idPedidoDetalle: 0 }); 
