...
<!-- 									<option value="ABONO">ABONO</option> -->
			...
			<div v-show="mostrarCorteComision" >
				<div class="ibox-title"><h3>Corte de Comisi&oacute;n  {{ comision.idcortecomision }} : {{ comision.fechainicio }} - {{ comision.fechafin }} <span v-if="comision.porcentajeVenta > 0">** Porcentaje Logrado de Venta {{ comision.porcentajeVenta }} **</span> <a target="_blank" :href="'<?php echo URL_BASE; ?>pagocomision/'  + comision.idcortecomision" class="btn btn-primary btn-xs"><i class="fa fa-print"></i> Imprimir</a></h3> </div>
				<div class="ibox-content m-b-sm border-bottom">
						...
						<div class="col-sm-12">
                            ...
                            <div class="row text-left">
                                ...
                                <div class="col-xs-2 text-success">
            						<span class="h4 font-bold m-t block">$ {{ formatNumber(comision.incentivo) }}</span>
            						<small class="text-muted m-b block">Incentivo ({{comision.incentivoPorcentaje}} %) </small>
            					</div>
                                
                                <div class="text-danger col-xs-2">
