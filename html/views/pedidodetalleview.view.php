...
<!--                                             <small>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</small></td> -->
                            ...
                            <div v-show="otrosServicios.length >= 0">
                            	<hr>
                            	...
                            	<div class="table-responsive m-t">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <tr v-for="os in otrosServicios">                                    	
                                            <td><div><strong>{{ os.descripcion }}</strong></div></td>
                                            <td class="text-right">{{ formatNumber(os.monto) }}</td>
    <!--                                             <small>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</small></td> -->
