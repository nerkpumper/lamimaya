...
$_addHead="
 		...
 		<link href='".URL_BASE."assets/inspinia/css/plugins/summernote/summernote.css' rel='stylesheet'>
 		<link href='".URL_BASE."assets/inspinia/css/plugins/summernote/summernote-bs3.css' rel='stylesheet'>
 		
 		";

$_addScript="
 		<script src=\"".URL_BASE."assets/inspinia/js/plugins/iCheck/icheck.min.js\"></script>
 		<script src=\"".URL_BASE."assets/inspinia/js/plugins/summernote/summernote.min.js\"></script>
				...
				<div class="ibox-content mailbox-content">
					<div class="file-manager">
						...
						<ul class="folder-list m-b-md" style="padding: 0">
							...
							<li><a href="mailbox.html"> <i class="fa fa-envelope-o"></i> Send
									Mail
							</a></li>
							...
							<li><a href="mailbox.html"> <i class="fa fa-trash-o"></i> Trash
							</a></li>
						</ul>
						<h5>Categories</h5>
						<ul class="category-list" style="padding: 0">
							<li><a href="#"> <i class="fa fa-circle text-navy"></i> Work
							</a></li>
							<li><a href="#"> <i class="fa fa-circle text-danger"></i>
									Documents
							</a></li>
							<li><a href="#"> <i class="fa fa-circle text-primary"></i> Social
							</a></li>
		...
		<div class="col-lg-9 animated fadeInRight">
			<div class="mail-box-header">
				<div class="pull-right tooltip-demo">
					...
					<a href="mailbox.html" class="btn btn-danger btn-sm"
			...
			<div class="mail-box">
				...
				<div class="mail-text h-200">
					...
					<div v-html="cadenita" class="summernote">
				...
				<div class="mail-body text-right tooltip-demo">
					<a href="mailbox.html" class="btn btn-sm btn-primary"
						...
						data-placement="top" title="Discard email"><i class="fa fa-times"></i>
						Discard</a> <a href="mailbox.html" class="btn btn-white btn-sm"
						data-toggle="tooltip" data-placement="top"
						title="Move to draft folder"><i class="fa fa-pencil"></i> Draft</a>
				</div>
				<div class="clearfix"></div>
