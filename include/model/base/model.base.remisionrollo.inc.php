<?php
	...
	class ModeloBaseRemisionrollo extends clsBasicCommon
	{
		#------------------------------------------------------------------------------------------------------#
		#----------------------------------------------Propiedades---------------------------------------------#
		#------------------------------------------------------------------------------------------------------#
		var $_nombreClase="base.ModeloBaseRemisionrollo";
		...
		{
			if($idRemisionRollo==0||$idRemisionRollo==""||!is_numeric($idRemisionRollo)|| (is_string($idRemisionRollo)&&!ctype_digit($idRemisionRollo)))return $this->setError("Tipo de dato incorrecto para idRemisionRollo.");
		...
		public function setAlmacenLAGOS()
		{
			$this->almacen='LAGOS';
		}
		public function setAlmacenTRANSITO()
		{
			$this->almacen='TRANSITO';
		}
		...
		public function setAlmacenOriginalOBRA()
		{
			$this->almacenOriginal='OBRA';
		}
		public function setAlmacenOriginalLAGOS()
		{
			$this->almacenOriginal='LAGOS';
		}
		public function setAlmacenOriginalTRANSITO()
		{
			$this->almacenOriginal='TRANSITO';
		}
		...
		protected function Insertar()
		{
			try
			{
				$SQL="INSERT INTO " . $this->__tableName . " (remision,
				                                              remisionRollo_rollo_idRollo,
				                                              noRollo,
				                                              kilos,
				                                              existencia,
				                                              ...
				                                              estado,
				                                              costokg)
						VALUES('" . mysqli_real_escape_string($this->dbLink,$this->remision) . "',
				...
				if(!$result)
					return $this->setSystemError("Error en la insercion de registro.","[" . $SQL . "][" . mysqli_error($this->dbLink) . "][ModeloBaseRemisionrollo::Insertar]");
				
				$this->idRemisionRollo=mysqli_insert_id($this->dbLink);
				return true;
			}
			catch (Exception $e)
			{
		...
		protected function Actualizar()
		{
			try
			{
				$SQL="UPDATE " . $this->__tableName . " SET remision='" . mysqli_real_escape_string($this->dbLink,$this->remision) . "',
					...
					WHERE idRemisionRollo=" . $this->idRemisionRollo;
				
				$result=mysqli_query($this->dbLink,$SQL);
				if(!$result)
					return $this->setSystemError("Error en la actualizacion de registro.","[" . $SQL . "][" . mysqli_error($this->dbLink) . "][ModeloBaseRemisionrollo::Update]");
		...
		public function Borrar()
		{
			...
			try
			{
				...
				WHERE idRemisionRollo=" . mysqli_real_escape_string($this->dbLink,$this->idRemisionRollo);
				$result=mysqli_query($this->dbLink,$SQL);
				if(!$result)
					return $this->setSystemError("Error en el borrado de registro.","[" . $SQL . "][" . mysqli_error($this->dbLink) . "][ModeloBaseRemisionrollo::Borrar]");
			}
			catch (Exception $e)
			{
				return $this->setErrorCatch($e);
		...
		public function getDatos()
		{
			try
			{
				...
				$result=mysqli_query($this->dbLink,$SQL);
				if(!$result)
					return $this->setSystemError("Error en la obtencion de detalles de registro.","[ModeloBaseRemisionrollo::getDatos][" . $SQL . "][" . mysqli_error($this->dbLink) . "]");
