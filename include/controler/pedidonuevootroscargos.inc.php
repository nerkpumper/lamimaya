...
function cargarListaRollos()
{
    ...
    $lstRollos = $rollos->getAll("idrollo, codigo, descauto, existencia, calibre, pies,
...
function levantarPedido($idClienteSeleccionado, $subtotalPedido, $ivaPedido, $descuentoPedido, $totalPedido, $tipoPrecioGalvamex ,$detalle, $recogeRecibe,$strPersona, $strDireccion, $strNumero, $strColonia, $strCiudad, $fechaEntrega, $horaEntrega, $tipoPedido, $porDescuento, $maxDescuentoIndividual, $descuentoIndividual, $observacionPedido, $totalOtrosCargos, $otrosCargos)
{
    global $objSession;
    $r = new xajaxResponse();
    $blnDoCommit=true;
