...
// 	$r->mostrarAviso($debug);
	...
	function loadCotizacion($idCotizacion)
	{
		...
		$r->script("setTimeout( function() {mdlExitWait();},1100);");
...
// 	                          ,$strPersona, $strDireccion, $strNumero, $strColonia, $strCiudad, $fechaEntrega, $horaEntrega, $tipoPedido, $porDescuento, $maxDescuentoIndividual, $descuentoIndividual, $observacionPedido, $totalOtrosCargos, $otrosCargos
	...
	function levantarPedido($idClienteSeleccionado, $subtotalPedido, $ivaPedido, $descuentoPedido, $totalPedido, $tipoPrecioGalvamex ,$detalle, $recogeRecibe, $sucursalPreferencia, $strPersona, $strDireccion, $strNumero, $strColonia, $strCiudad, $fechaEntrega, $horaEntrega, $fechaAbierta, $pedidoExpress, $tipoPedido, $porDescuento, $maxDescuentoIndividual, $descuentoIndividual, $observacionPedido, $totalOtrosCargos, $otrosCargos, $molCostoDobles, $molCostoCorte, $buenfintipopago, $fechaEntregaPorDefinir, $tipoObra, $isCotizacion = false)
	{
		global $objSession;
		$r = new xajaxResponse();
...
// 		    $r->mostrarAviso("TODO BIEN 1150"); return $r;
...
// 	$lstMateriales = $material->getForSelect("idMaterial", "concat(clave, ' - ', nombre)", "estado = 'ACTIVO'");
	...
	$lstSucursales = $sucursales->getAll();
