									...
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            							<div class="form-group">
            								<label class="control-label">Longitud (Metros Lineales)</label> <input
            									...
            									oninput="this.value = this.value.replace(/[^0-9.\t]/g, '').replace(/(\..*)\./g, '$1');"
            									maxlength="9" class="form-control">
            								<div v-show="molCantUnidad > 3.05 || molCantUnidad <= 0" class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                    							<div class="alert alert-danger">
                    								Este valor debe ser mayor a cero y menor a 3.05
                    							</div>
                    						</div>
            							</div>
            						</div>
			...
			<div class="ibox">
				...
				<div class="ibox-content">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"
							style="padding-top: 10px">
							<a href="<?php echo URL_BASE?>pedidonuevo4"
