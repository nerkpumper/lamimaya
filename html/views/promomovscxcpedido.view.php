<?php
$titlePage = "Movimientos CxC Pedido";
$breadCum = "Promotor/Movimientos CxC a Pedido";
$buttonAction = "Ir a Listado de Notas del Cliente/fnRegresarAListado";
$_lugar = LUGAR_PROMOTOR_MOVTOSCXCPEDIDO
...
<div v-show="!seleccionarPedido">
	...
	<div class="row m-b-lg m-t-lg">
		...
		<div class="col-md-6">
			...
			<br>
			<button @click.prevent="refreshMovtos" class="btn btn-primary"><i class="fa fa-refresh"></i> Refrescar Datos y Movimientos del Cliente</button>
	...
	<div class="row">
		<div class="col-lg-3 ">
			<div class="ibox float-e-margins text-danger">
				<div class="ibox-title ">
					<!-- 					<span class="label label-success pull-right">Ver Todos Pedidos</span> -->
					<h5>Cargos Promotor</h5>
				</div>
				<div class="ibox-content">
					<h1 class="no-margins">$ {{ formatNumber(cargosPromotor) }}</h1>
					<!-- 					<div class="stat-percent font-bold text-success"> -->
					<!-- 						98% <i class="fa fa-bolt"></i> -->
					<!-- 					</div> -->
					<small>Total</small>
		...
		<div class="col-lg-3">
			<div class="ibox float-e-margins text-success">
				<div class="ibox-title " >
					<!-- 					<span class="label label-info pull-right">Ver Pedidos Saldados</span> -->
					<h5>Abonos Promotor</h5>
				</div>
				<div class="ibox-content">
					<h1 class="no-margins">$ {{ formatNumber(abonosPromotor) }}</h1>
					<!-- 					<div class="stat-percent font-bold text-info"> -->
					<!-- 						20% <i class="fa fa-level-up"></i> -->
					<!-- 					</div> -->
					<small>Total</small>
		...
		<div class="col-lg-3">
			<div class="ibox float-e-margins text-navy">
				<div class="ibox-title">
					<!-- 					<span class="label label-danger pull-right">Ver Pedidos Por Saldar</span> -->
					<h5>Por Saldar Promotor</h5>
				</div>
				<div class="ibox-content">
					<h1 class="no-margins">$ {{ formatNumber(saldoPromotor) }}</h1>
					<!-- 					<div class="stat-percent font-bold text-navy"> -->
					<!-- 						44% <i class="fa fa-level-up"></i> -->
					<!-- 					</div> -->
					<small>Total</small>
...
<!-- 						<button v-show="saldada == 'NO'" class="btn btn-primary" @click.prevent="generarMovimiento">Generar Movimiento</button> -->
							<button @click.prevent="sendToExcelPromotor" class="btn btn-outline btn-primary dim pull-right" type="button"><i class="fa fa-file-excel-o"></i> Exportar</button>
									<table id="tablaToExcelPromotor" class="table table-bordered table-hover ">
										<thead>
											<tr>
										...
										<tbody>
											<tr v-for="item in movimientospromotor">
												<td>{{ item.fecha }}</td>
												<td>{{ item.movimiento }}</td>
												<td class="text-right">$ {{ formatNumber(item.saldoactual) }}</td>
												<td class="text-right"
