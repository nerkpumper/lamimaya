...
<!-- 				<div class="stat-percent font-bold text-success">98% <i class="fa fa-bolt"></i></div> -->
				<small v-if="ff != '' && fi != ''">Del 01/01/2019 al {{ ff }}</small>
			</div>
		</div>
	</div>
	<div class="col-lg-3">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<h1 class="no-margins">$ {{ formatNumber(totalInicialMendez) }}</h1>
	...
	<div class="col-lg-3">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<h1 class="no-margins">$ {{ formatNumber(inventarioRollosFechas) }}</h1>
	...
	<div class="col-lg-3">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<h1 class="no-margins">$ {{ formatNumber(pedidosFechas) }}</h1>
