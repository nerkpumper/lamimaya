...
$ctes = $cliente->getDataSet("select idCliente from cliente where idcliente in (762, 113, 159, 1131, 1680)");
    ...
    $pdf->Output(); return;
        ...
        * {
                        ...
                        <table class='main' width='100%' cellpadding='0' cellspacing='0'>
                            <tr>
                                <td style='background: #1ab394; font-size: 16px;    color: #fff;    font-weight: 500;    padding: 20px;    text-align: center;    border-radius: 3px 3px 0 0;'>
                                    PLAN PROTECCION PARA ". $pdf->__cliente."
                                </td>
                            </tr>
                            <tr>
        ...
        //     $email->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            ...
            $email->Subject   = 'Plan Proteccion: ' . $pdf->__cliente;
            $email->IsHTML(true);
            $email->Body      = $bodyMail;
