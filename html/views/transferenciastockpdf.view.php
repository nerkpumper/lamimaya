...
class PDF extends PDFNerk
{
    ...
    var $__sucursalDestino = "";
    var $__sucursalOrigen = "";
...
// 	    $this->putText(10, "mita");  
	    ...
	    $this->setCurrentY($yInicial );
	    $this->putTextCenter("TRANSFERENCIAS STOCK ", 65);
        ...
        $this->nextRow();
        $this->nextRow();
        // $this->putTextCenter("ORIGEN: " . $this->__sucursalOrigen."          DESTINO: " . $this->__sucursalDestino, -10);
        $this->putText(10, "ORIGEN:");
        $this->putTextRight("DESTINO:", 60);
        $this->SetFont('Arial','B',10);
        // $this->previousRow();
        $this->putText(30, $this->__sucursalOrigen);
        $this->putText(160, $this->__sucursalDestino);
...
// 	    {
			...
			$this->Line(25, $yInicial+52, 25, $yInicial+42+142);

			$this->Line(37, $yInicial+52, 37, $yInicial+42+142);
	...
	function printDatosPedido($rsDetalle, $hoja)
	{
		...
		$index = -1;
  		...
  		foreach ($rsDetalle as $item)
  		{
  			...
  			{
                  $this->putText(17, $item["idProducto"]);
                  $this->putText(27, $item["cantidad"]);

                  $this->SetFont('Arial','',9);

                  $this->putText(38, $item["producto"]);
...
vp.idProducto, vp.descauto producto, td.cantidad
