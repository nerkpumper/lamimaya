...
class xajaxResponse
{
	...
	*/
	...
	public function mostrarPena($mensaje="")
	{
		if($mensaje=="")
			$this->call("mostrarPena");
		else
			$this->call("mostrarPena",$mensaje);
	}
	//("Contenido de la nota","Categoria de la nota","787878787878787","<option value='1'>Uno</option><option value='2' selected>dos</option>");
	public function mostrarNota($Contenido="",$categoria="",$ivrid="",$opciones="")
	{
		$this->call("mostrarNota",$Contenido,$categoria,$ivrid,$opciones);
	}
	...
	{
		if($mensaje=="")
			$this->call("mostrarMensaje");
		else
			$this->call("mostrarMensaje",$mensaje);
	}
	*/
	public function mostrarMsgs($mensaje="")
	{
		$mensaje = ($mensaje);
		if($mensaje=="")
			$this->call("mostrarMsgs");
		else
			$this->call("mostrarMsgs",$mensaje);
	}
	...
	public function saSuccess($mensaje="")
	{
		...
		if($mensaje=="")
			$this->call("saSuccess");
				...
				$this->call("saSuccess",$mensaje);
	}

	public function saClose($segundos)
	{
		$this->call("saClose", $segundos);
	...
	public function saInfo($mensaje="")
	{
		...
		if($mensaje=="")
			$this->call("saInfo");
				...
				$this->call("saInfo",$mensaje);
	}

	/*
	public function mostrarNOK($mensaje="")
	{
		if($mensaje=="")
			$this->call("mostrarNOK");
		else
			$this->call("mostrarNOK",$mensaje);
	}
	*/
