...
//			echo "<!--" . print_r($aSections, true) . "-->";
			...
			if (false == $this->bValidateHash || $sHash == $this->sHash)
			{
				...
				$nrkxajaxscriptplugin243 = new xajaxCustomResponse($sType);
				$objResponse =& $nrkxajaxscriptplugin243;
...
$nrkxajaxscriptplugin267 = xajaxPluginManager::getInstance();
$objPluginManager =& $nrkxajaxscriptplugin267;

$nrkxajaxscriptplugin270 = new xajaxScriptPlugin();
$objPluginManager->registerPlugin($nrkxajaxscriptplugin270, 9999);
