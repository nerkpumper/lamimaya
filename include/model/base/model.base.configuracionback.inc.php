<?php
	...
	class ModeloBaseConfiguracion extends clsBasicCommon
	{
		...
		var $rangoMetros1Inicio='';
		var $rangoMetros1Fin='';
		var $rangoMetros2Inicio='';
		var $rangoMetros2Fin='';
		var $rangoMetros3Inicio='';
		var $rangoMetros3Fin='';
		var $pesoXCalibre20='';
		var $pesoXCalibre22='';
		var $pesoXCalibre24='';
		...
		protected function limpiarPropiedades()
		{
			...
			$this->rangoMetros1Inicio='';
			$this->rangoMetros1Fin='';
			$this->rangoMetros2Inicio='';
			$this->rangoMetros2Fin='';
			$this->rangoMetros3Inicio='';
			$this->rangoMetros3Fin='';
			$this->pesoXCalibre20='';
			$this->pesoXCalibre22='';
			$this->pesoXCalibre24='';
			$this->pesoXCalibre26='';
			$this->pesoXCalibre28='';
			$this->pedidoDescuento='';
			$this->comision1R1='';
			$this->comision1R2='';
			$this->comision1R3='';
			$this->comision2R1='';
