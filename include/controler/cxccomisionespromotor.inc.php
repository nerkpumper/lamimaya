...
// 	    $r->saSuccess("holis");
	...
	function generarCorteComision($promotor, $pedidos, $deducciones, $totalAPagar, $totalDeducciones, $netoAPagar, $incentivo, $objetivoPorcentaje)
	{
		...
		else
		{
			...
			$cxccomision->setObservacion(utf8_encode("CORTE COMISIÓN, MONTO GENERADO"));
			...
			$cxccomision->setObservacion(utf8_encode("INCENTIVO DE COMISIÓN"));
			$cxccomision->setIdCorteComision($cc->getIdCorteComision());
			...
			{			    
			    ...
			    $cxcarrastrar->setObservacion(utf8_encode("CORTE COMISIÓN ANTERIOR NEGATIVO"));
