...
var app = new Vue ({
	...
	data:{
		...
		/* Costo */
		inventarioGalvamexHasta: 0,
		inventarioGalvamexKilosHasta: 0,
		inventarioGalvamexEntre: 0,
		inventarioGalvamexKilosEntre: 0,
		inventarioGalvamexSalidaEntre: 0,
		inventarioGalvamexSalidaKilosEntre: 0,
		
		inventarioStockGalvamexHasta: 0,
		inventarioStockEntradasGalvamexEntre: 0,
		inventarioStockSalidasGalvamexEntre: 0,
	...
	computed: {
		totalNeto: function(){
			return this.inventarioGalvamexHasta + this.inventarioStockGalvamexHasta + this.inventarioGalvamexEntre  + this.inventarioStockEntradasGalvamexEntre - this.inventarioGalvamexSalidaEntre - this.inventarioStockSalidasGalvamexEntre;
		},
		totalKilosNeto: function() {
			return this.inventarioGalvamexKilosHasta + this.inventarioGalvamexKilosEntre - this.inventarioGalvamexSalidaKilosEntre; 
		}
	},
	mounted: function() {
