...
Vue.component('cortecaja-entradas', {
        data: function () {
            return {
                idSucursal: 0,
                fechaApertura: '',
        ...
        methods: {
            ...
            loadPage: function(){
                ...
                axios.get(URL_BASE + 'api/cortecaja.api.php?method=getEntradasPage&idSucursal=' + this.idSucursal +  '&page=' + this.page + "&pageSize=" + this.pageSize + "&fechaApertura=" + this.fechaApertura + "&fechaCorte=" + this.fechaCorte, getAxiosHeaders())
