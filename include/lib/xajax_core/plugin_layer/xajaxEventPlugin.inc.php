	...
	function register($aArgs)
	{
		if (1 < count($aArgs))
		{
			...
			if (XAJAX_EVENT == $sType)
			{
				...
				{
					$nrkxajaxeventplugin130 = new xajaxEvent($sEvent);
					$xe =& $nrkxajaxeventplugin130;
			...
			if (XAJAX_EVENT_HANDLER == $sType)
			{
				...
				if (isset($this->aEvents[$sEvent]))
				{
					if (isset($aArgs[2]))
					{
						...
						{
							$nrkxajaxeventplugin156 = new xajaxUserFunction($xuf);
							$xuf =& $nrkxajaxeventplugin156;
						}
...
$nrkxajaxeventplugin228 = xajaxPluginManager::getInstance();
$objPluginManager =& $nrkxajaxeventplugin228;

$nrkxajaxeventplugin231 = new xajaxEventPlugin();
$objPluginManager->registerPlugin($nrkxajaxeventplugin231, 103);
